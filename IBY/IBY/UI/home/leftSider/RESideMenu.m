...
- (void)setupUI
{
  //  self.backgroundImage = [UIImage imageNamed:@"star.jpg"];
    UIImage *img = [UIImage imageNamed:@"bg_menu.png"];
    //self.backgroundImage = [self blurryImage:img withBlurLevel:0.5];
    self.backgroundImage = img;
    // self.view.backgroundColor = BYColor4DA6FF;
...
{
    [self hideMenuViewControllerAnimated:animated finish:nil];
}

- (void)hideMenuViewControllerAnimated:(BOOL)animated finish:(void (^)())finished
{
