...
#define BUBBLE_LEFT_IMAGE_NAME @"bg_im_receiver" // bubbleView 的背景图片
#define BUBBLE_RIGHT_IMAGE_NAME @"bg_im_sender"
...
#define BUBBLE_RIGHT_TOP_CAP_HEIGHT 36 // 文字在右侧时,bubble用于拉伸点的Y坐标

#define BUBBLE_LEFT_LEFT_CAP_WIDTH 30 // 文字在左侧时,bubble用于拉伸点的X坐标
#define BUBBLE_LEFT_TOP_CAP_HEIGHT 36 // 文字在左侧时,bubble用于拉伸点的Y坐标
